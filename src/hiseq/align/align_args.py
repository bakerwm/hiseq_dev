...
def get_args_index1(parser):
    ...
    group.add_argument('-x', '--index', required=False, 
        help='The alignment index for aligner')
...
def get_args_io2():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=example,
        formatter_class=argparse.RawTextHelpFormatter)
    parser.add_argument('-1', '--fq1', dest='fq1', nargs='+', required=True,
        help='reads in FASTQ files, support (*.gz), 1 file.')
    parser.add_argument('-2', '--fq2', dest='fq2', nargs='+', default=None,
        help='The second file of pair-end reads')
    parser.add_argument('-o', '--out-dir', dest='out_dir', default=None,
        help='Directory saving results, default: [cwd]')
    parser.add_argument('-n', '--smp-name', dest='smp_name', default=None, 
...
def get_args_align(parser):
    ...
    parser.add_argument('-l', '--large-insert', action='store_true',
        dest='large_insert',
    ...
    parser.add_argument('--genome-dir', dest='genome_dir', type=str, default=None,
