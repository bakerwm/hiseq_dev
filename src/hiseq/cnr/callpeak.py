...
from hiseq.utils.file import (
    check_dir, file_exists, file_abspath, file_prefix, remove_file
)
...
class CallPeak(object):
    ...
    def init_files(self):
        default_files = {
            'config_yaml': self.out_dir + '/config.yaml',
    ...
    def run_seacr(self):
        ...
        if file_exists(self.input):
            ...
            # save cmd
            cmd2_txt = self.out_dir + '/' + self.prefix + '.SEACR.ip_vs_input.sh'
    ...
    def run(self):
        ...
        msg = '\n'.join([
            ...
            '{:>14s} : {}'.format('out_dir', self.outdir),
