...
class RnaseqArgs(object):
    ...
    def init_parser(self):
        ...
        subparsers = parser.add_subparsers(
            title="sub-commands", help="choose one command"
        )
        self.build = subparsers.add_parser(
            "build",
            epilog=example_build,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        self.run = subparsers.add_parser(
            "run",
            epilog=example_run,
            formatter_class=argparse.RawTextHelpFormatter,
        )
        self.salmon = subparsers.add_parser(
            "salmon",
            epilog=example_salmon,
            formatter_class=argparse.RawTextHelpFormatter,
        )
