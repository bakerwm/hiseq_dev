...
from hiseq.run_trackhub.track_file import TrackFile
from hiseq.run_trackhub.utils import trackhub_config_template
...
#                 filterComposite = None
    ...
    def upload(self):
        if isinstance(self.remote_dir, str):
            ...
            # self.remote_hub_dir = os.path.join(self.remote_dir, self.hub_name)
            check_dir(self.remote_hub_dir, create_dirs=True)
            # construct tracks()
            tmp_dir = self.render()
